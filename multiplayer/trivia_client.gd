...
# Este método será llamado por el host via RPC: receive_questions(data)
@rpc
...
func _on_server_disconnected():
	...
	if has_node("Mensaje"):
		$Mensaje.text = "El host cerró la conexión"
