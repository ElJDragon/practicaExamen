...
# STATE MACHINE
# ============================================================================
# Máquina de estados genérica para gestionar transiciones
#
# DESIGN PATTERNS: State Pattern (Context)
# SOLID: [SRP] Responsabilidad única: Gestionar transiciones de estado
# ============================================================================
...
func transition_to(new_state: PlayerState) -> void:
    ...
    print(" Transición: " + old_state_name + "  " + _current_state.get_state_name())
