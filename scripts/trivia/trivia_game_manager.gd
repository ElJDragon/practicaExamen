...
#       de preguntas, ni lógica de red.
#
# [OCP] Open/Closed Principle (Principio Abierto/Cerrado)
#       Abierto para extensión mediante señales, cerrado para modificación.
#       Nuevas funcionalidades se pueden agregar escuchando las señales sin
#       modificar esta clase.
#
# Benefits:
# - Fácil de testear: lógica aislada sin dependencias de UI
...
# Señales para comunicación desacoplada (DIP - Dependency Inversion)
...
## Muestra la siguiente pregunta o termina el juego si no hay más
...
## @param answer_index: Índice de la respuesta seleccionada (0-3)
...
## Retorna el número total de preguntas en la partida
