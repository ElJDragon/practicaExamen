...
# Nodos de high score (se crearán dinámicamente)
...
func create_high_score_ui():
	...
	name_input_label.text = "🏆 Nuevo Puntaje Maximo! 🏆"
...
func _on_game_over():
	...
	if is_high_score:
		...
		print("🎉 Felicidades! Position: #", rank + 1)
		show_name_input()
	else:
...
func show_name_input():
	...
	print("📝 Waiting for player name input...")

func _on_name_submitted(player_name: String):
	"""Manejar el envío del nombre del jugador"""
	...
	print("✅ High score saved: ", player_name, " - ", current_score)
...
func show_game_over_with_scores():
	...
	var scores_text = "═══ TOP 5 Mejores Puntajes ═══\n\n"
